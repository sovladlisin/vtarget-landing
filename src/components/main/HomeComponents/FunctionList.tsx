        ...
        <div className={'function-list-container' + mobileClass}>
            <div>
                ...
                <ul>
                    ...
                    <li>генерация ссылок с utm-метками для сайтов и для Senler</li>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>копируйте и вставляйте параметры объявлений как обычный текст (сообщества, аудитории)</li>
                </ul>
            </div>
            <div>
                ...
                <ul>
                    ...
                    <li>быстрая отправка объявлений на повторную модерацию</li>
                </ul>
            </div>
            <div>
